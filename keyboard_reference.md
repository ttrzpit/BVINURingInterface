...
-----------|----------|--------------------------------------------|----------------------------|-------------------------|-------------------------------------------------------------------------------
 ...
 `w`       | 119      | "Scan + mask the world markers (blank ws)" | OBJ_SCAN, OBJ_SEL, OBJ_RUN | (same as previous)      | "Scanning world markers (keep the workspace clear)... N" then "Masked N world marker(s) - place the objects, then [t] to train." (see Note5)
...
-----------|---------------------------------------------------------|-------------------------
 ...
 `w`       | Scan the blank workspace, mask world markers white      | OBJECTS
